...
namespace wmma {
  ...
  __CUDA_MMA_DEVICE_DECL__ void store_matrix_sync(__half *p, const fragment<accumulator,16, 16, 16, __half>& a, unsigned ldm, layout_t layout) {
    if (layout == mem_row_major)
      __hmma_m16n16k16_st_c_f16((__attribute__((address_space(3))) int*)p, (int*)&a, ldm, 0);
    else
      __hmma_m16n16k16_st_c_f16((__attribute__((address_space(3))) int*)p, (int*)&a, ldm, 1);
  }
