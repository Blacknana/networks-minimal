...
BlockFusionKernel_float_float_float_float_float_cuda_Pad_Convolution_119(
  ...
  if ((int)blockIdx.x >= 0 && (int)blockIdx.x <= 63) {
    Convolution_float_float_float_cuda_Convolution_1341_block_kernel(
        input0, input2, output1, threadIdx.x, blockIdx.x - 0, shared_buffer);
  } else if ((int)blockIdx.x >= 64 && (int)blockIdx.x <= 1797) {
...
fused2_DepthwiseConv2dNative_float_float_float_cuda_DepthwiseConv2dNative_523_block_kernel(
...
BlockFusionKernel_float_float_float_float_float_float_float_float_float_float_float_float_float_float_float_float_float_float_float_float_float_float_float_cuda_DepthwiseConv2dNative_DepthwiseConv2dNative_Slice_DepthwiseConv2dNative_DepthwiseConv2dNative_DepthwiseConv2dNative_DepthwiseConv2dNative_fused_kernel_2(
  ...
  if ((int)blockIdx.x >= 0 && (int)blockIdx.x <= 63) {
    ...
    fused2_DepthwiseConv2dNative_float_float_float_cuda_DepthwiseConv2dNative_523_block_kernel(
        input5, input7, input8, output4, output5, threadIdx.x, blockIdx.x - 832,
        NULL);
  }
  // else if((int)blockIdx.x >= 1088 && (int)blockIdx.x <= 1343)
  //{
  //    DepthwiseConv2dNative_float_float_float_cuda_DepthwiseConv2dNative_523_block_kernel(input5,
  //    input8, output5, threadIdx.x, blockIdx.x - 1088, NULL);
  //}
  else if ((int)blockIdx.x >= 1344 - 256 && (int)blockIdx.x <= 1599 - 256) {
    DepthwiseConv2dNative_float_float_float_cuda_DepthwiseConv2dNative_523_block_kernel(
        input9, input10, output6, threadIdx.x, blockIdx.x - 1344 + 256, NULL);
  } else if ((int)blockIdx.x >= 1600 - 256 && (int)blockIdx.x <= 2111 - 256) {
    Slice_float_float_cuda_Slice_500_block_kernel(
        input4, output2, threadIdx.x, blockIdx.x - 1600 + 256, NULL);
  }
}
