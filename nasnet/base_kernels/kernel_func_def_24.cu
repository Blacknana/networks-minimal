...
void Constant_float_cuda_Constant_305(cudaStream_t stream, float *output0) {
  std::ifstream bin_file("./Constant/Constant_305_0.bin",
...
void Constant_float_cuda_Constant_2665(cudaStream_t stream, float *output0) {
  std::ifstream bin_file("./Constant/Constant_2665_0.bin",
                         std::ios::in | std::ios::binary);
  if (bin_file.fail()) {
...
void Constant_float_cuda_Constant_140(cudaStream_t stream, float *output0) {
  std::ifstream bin_file("./Constant/Constant_140_0.bin",
                         std::ios::in | std::ios::binary);
  if (bin_file.fail()) {
...
void Constant_float_cuda_Constant_2959(cudaStream_t stream, float *output0) {
  std::ifstream bin_file("./Constant/Constant_2959_0.bin",
                         std::ios::in | std::ios::binary);
  if (bin_file.fail()) {
...
void Constant_float_cuda_Constant_3132(cudaStream_t stream, float *output0) {
  std::ifstream bin_file("./Constant/Constant_3132_0.bin",
                         std::ios::in | std::ios::binary);
  if (bin_file.fail()) {
...
// Node name:	Constant_2942
// Description:	Constant
// Input:
// Output:
//	- name: Constant_2942_0	type: float	shape: Shape{1, 128, 8, 8}
void Constant_float_cuda_Constant_2942(cudaStream_t stream, float *output0) {
  std::ifstream bin_file("./Constant/Constant_2942_0.bin",
                         std::ios::in | std::ios::binary);
  if (bin_file.fail()) {
    printf("Load Constant_2942_0 failed.\n");
    exit(1);
  }
  char *tmp_mem = new char[32768];
  bin_file.read(tmp_mem, 32768);
...
void Constant_float_cuda_Constant_3100(cudaStream_t stream, float *output0) {
  std::ifstream bin_file("./Constant/Constant_3100_0.bin",
                         std::ios::in | std::ios::binary);
  if (bin_file.fail()) {
...
void Constant_float_cuda_Constant_124(cudaStream_t stream, float *output0) {
  std::ifstream bin_file("./Constant/Constant_124_0.bin",
                         std::ios::in | std::ios::binary);
  if (bin_file.fail()) {
...
void Constant_float_cuda_Constant_2146(cudaStream_t stream, float *output0) {
  std::ifstream bin_file("./Constant/Constant_2146_0.bin",
                         std::ios::in | std::ios::binary);
  if (bin_file.fail()) {
...
void Constant_float_cuda_Constant_281(cudaStream_t stream, float *output0) {
  std::ifstream bin_file("./Constant/Constant_281_0.bin",
                         std::ios::in | std::ios::binary);
  if (bin_file.fail()) {
...
void Constant_float_cuda_Constant_3048(cudaStream_t stream, float *output0) {
  std::ifstream bin_file("./Constant/Constant_3048_0.bin",
                         std::ios::in | std::ios::binary);
  if (bin_file.fail()) {
...
// Fused functions:
// Convolution_float_float_float_cuda_Convolution_925<<<dim3(1, 16, 4), dim3(8,
// 1, 16), 0, 0>>>(DepthwiseConv2dNative_917_0, Constant_2266_0,
// Convolution_925_0);
// DepthwiseConv2dNative_float_float_float_cuda_DepthwiseConv2dNative_913<<<dim3(128,
// 1, 1), dim3(128, 1, 1), 0, 0>>>(Relu_910_0, Constant_436_0,
// DepthwiseConv2dNative_913_0);
// DepthwiseConv2dNative_float_float_float_cuda_DepthwiseConv2dNative_914<<<dim3(128,
// 1, 1), dim3(128, 1, 1), 0, 0>>>(Relu_910_0, Constant_134_0,
// DepthwiseConv2dNative_914_0);
// DepthwiseConv2dNative_float_float_float_cuda_DepthwiseConv2dNative_915<<<dim3(128,
// 1, 1), dim3(128, 1, 1), 0, 0>>>(Relu_910_0, Constant_327_0,
// DepthwiseConv2dNative_915_0); Add_float_float_float_cuda_Add_916<<<dim3(32,
// 1, 1), dim3(512, 1, 1), 0, 0>>>(AvgPool_911_0, AvgPool_911_0, Add_916_0);
// Deduped function map: <src_function_name : deduped_function_name>
// DepthwiseConv2dNative_float_float_float_cuda_DepthwiseConv2dNative_915 :
// DepthwiseConv2dNative_float_float_float_cuda_DepthwiseConv2dNative_914
...
Convolution_float_float_float_cuda_Convolution_925_block_kernel(
...
// 64, 16, 16}
__device__ __forceinline__ void
DepthwiseConv2dNative_float_float_float_cuda_DepthwiseConv2dNative_913_block_kernel(
    float *input0, float *input1, float *output0, int thread_id, int block_id,
    char *shared_buffer) {
  if (thread_id >= 128) {
    return;
...
// 64, 16, 16}
__device__ __forceinline__ void
DepthwiseConv2dNative_float_float_float_cuda_DepthwiseConv2dNative_914_block_kernel(
    float *input0, float *input1, float *output0, int thread_id, int block_id,
    char *shared_buffer) {
  if (thread_id >= 128) {
    return;
...
__device__ __forceinline__ void
fuse2_DepthwiseConv2dNative_float_float_float_cuda_DepthwiseConv2dNative_914_block_kernel(
...
// Output:
//	- name: Add_916_0	type: float	shape: Shape{1, 64, 16, 16}
__device__ __forceinline__ void Add_float_float_float_cuda_Add_916_block_kernel(
    float *input0, float *input1, float *output0, int thread_id, int block_id,
    char *shared_buffer) {
  if (thread_id >= 512) {
    return;
...
__device__ __forceinline__ void
Fuse_AvgPool_911_Add_916(float *input0, float *output0, int thread_id,
...
#pragma unroll 4
    ...
    // output
    output0[index] = add(avgval, avgval);
  }
}

extern "C" __global__ void
BlockFusionKernel_float_float_float_float_float_float_float_float_float_float_float_float_cuda_Convolution_DepthwiseConv2dNative_DepthwiseConv2dNative_DepthwiseConv2dNative_Add_60(
  ...
  if ((int)blockIdx.x >= 0 && (int)blockIdx.x <= 31) {
    Fuse_AvgPool_911_Add_916(input6, output4, threadIdx.x, blockIdx.x - 0,
                             shared_buffer);
    // Add_float_float_float_cuda_Add_916_block_kernel(input6, input6, output4,
    // threadIdx.x, blockIdx.x - 448 + 0, shared_buffer);
    ...
    DepthwiseConv2dNative_float_float_float_cuda_DepthwiseConv2dNative_913_block_kernel(
        input2, input3, output1, threadIdx.x, blockIdx.x - 96, shared_buffer);
  } else if ((int)blockIdx.x >= 224 && (int)blockIdx.x <= 351) {
    fuse2_DepthwiseConv2dNative_float_float_float_cuda_DepthwiseConv2dNative_914_block_kernel(
        input2, input4, input5, output2, output3, threadIdx.x, blockIdx.x - 224,
        shared_buffer);
    // DepthwiseConv2dNative_float_float_float_cuda_DepthwiseConv2dNative_914_block_kernel(input2,
    // input4, output2, threadIdx.x, blockIdx.x - 224, shared_buffer);
  }
  // else if((int)blockIdx.x >= 352 && (int)blockIdx.x <= 479)
  // {
  //     DepthwiseConv2dNative_float_float_float_cuda_DepthwiseConv2dNative_914_block_kernel(input2,
  //     input5, output3, threadIdx.x, blockIdx.x - 352, shared_buffer);
  // }
}
...
void Constant_float_cuda_Constant_280(cudaStream_t stream, float *output0) {
  std::ifstream bin_file("./Constant/Constant_280_0.bin",
                         std::ios::in | std::ios::binary);
  if (bin_file.fail()) {
...
// Fused functions:
// FusedKernel_float_float_float_float_cuda_Add_Add_5<<<dim3(64, 1, 1),
// dim3(512, 1, 1), 0, 0>>>(Convolution_564_0, Constant_2812_0, Slice_500_0,
// Add_570_0); FusedKernel_float_float_float_float_cuda_Add_Add_6<<<dim3(64, 1,
// 1), dim3(512, 1, 1), 0, 0>>>(Convolution_566_0, Constant_2813_0,
// BatchNormInference_538_0, Add_571_0); Deduped function map:
// <src_function_name : deduped_function_name>
// FusedKernel_float_float_float_float_cuda_Add_Add_6 :
// FusedKernel_float_float_float_float_cuda_Add_Add_5
...
//	- name: Add_570_0	type: float	shape: Shape{1, 32, 32, 32}
// Fused functions:
// Add_float_float_float_cuda_Add_2076<<<dim3(64, 1, 1), dim3(512, 1, 1), 0,
// 0>>>(Convolution_564_0, Constant_2812_0, BatchNormInference_568_0);
// Add_float_float_float_cuda_Add_570<<<dim3(64, 1, 1), dim3(512, 1, 1), 0,
// 0>>>(BatchNormInference_568_0, Slice_500_0, Add_570_0);
__device__ __forceinline__ void
FusedKernel_float_float_float_float_cuda_Add_Add_5_block_kernel(
...
extern "C" __global__ void
BlockFusionKernel_float_float_float_float_float_float_float_float_cuda_fused_kernel_fused_kernel_8(
    float *input0, float *input1, float *input2, float *input3, float *input4,
...
void AvgPool_float_float_cuda_lib_AvgPool_888(cudnnHandle_t cudnn_handle,
