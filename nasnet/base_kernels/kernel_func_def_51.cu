...
__device__ __forceinline__ void
fuse2_Convolution_float_float_float_cuda_Convolution_1477_block_kernel(
  ...
  float *pad_temp_shared = (float *)(shared_buffer + 0);
  float *input1_shared = (float *)(shared_buffer + 2048);
  float *input1_shared1 = (float *)(shared_buffer + 4096);
    ...
    float *compute = output0;
    {
      ...
      input1_shared[((((((int)threadIdx.z) * 32) + (((int)threadIdx.y) * 8)) +
          ...
          input1[(((((((int)blockIdx.z) * 12288) + (((int)threadIdx.z) * 768)) +
                   ...
                   (((int)threadIdx.x) * 2)) +
                  1)];
      input1_shared1[(((((int)threadIdx.z) * 32) + (((int)threadIdx.y) * 8)) +
                      (((int)threadIdx.x) * 2))] =
          input2[((((((int)blockIdx.z) * 12288) + (((int)threadIdx.z) * 768)) +
                   (((int)threadIdx.y) * 8)) +
                  (((int)threadIdx.x) * 2))];
      input1_shared1[((((((int)threadIdx.z) * 32) + (((int)threadIdx.y) * 8)) +
                       (((int)threadIdx.x) * 2)) +
      ...
      compute_local1[0] =
          (compute_local1[0] +
           (pad_temp_shared[((((int)threadIdx.y) * 4) + ((int)threadIdx.x))] *
            input1_shared1[(((int)threadIdx.z) * 32)]));
      compute_local1[0] =
          (compute_local1[0] +
           (pad_temp_shared[(((((int)threadIdx.y) * 4) + ((int)threadIdx.x)) +
                             16)] *
            input1_shared1[((((int)threadIdx.z) * 32) + 1)]));
      compute_local1[0] =
          (compute_local1[0] +
           (pad_temp_shared[(((((int)threadIdx.y) * 4) + ((int)threadIdx.x)) +
                             32)] *
            input1_shared1[((((int)threadIdx.z) * 32) + 2)]));
      compute_local1[0] =
          (compute_local1[0] +
           (pad_temp_shared[(((((int)threadIdx.y) * 4) + ((int)threadIdx.x)) +
                             48)] *
            input1_shared1[((((int)threadIdx.z) * 32) + 3)]));
      compute_local1[0] =
          (compute_local1[0] +
           (pad_temp_shared[(((((int)threadIdx.y) * 4) + ((int)threadIdx.x)) +
                             64)] *
            input1_shared1[((((int)threadIdx.z) * 32) + 4)]));
      compute_local1[0] =
          (compute_local1[0] +
           (pad_temp_shared[(((((int)threadIdx.y) * 4) + ((int)threadIdx.x)) +
                             80)] *
            input1_shared1[((((int)threadIdx.z) * 32) + 5)]));
      compute_local1[0] =
          (compute_local1[0] +
           (pad_temp_shared[(((((int)threadIdx.y) * 4) + ((int)threadIdx.x)) +
                             96)] *
            input1_shared1[((((int)threadIdx.z) * 32) + 6)]));
      compute_local1[0] =
          (compute_local1[0] +
           (pad_temp_shared[(((((int)threadIdx.y) * 4) + ((int)threadIdx.x)) +
                             112)] *
            input1_shared1[((((int)threadIdx.z) * 32) + 7)]));
      compute_local1[0] =
          (compute_local1[0] +
           (pad_temp_shared[(((((int)threadIdx.y) * 4) + ((int)threadIdx.x)) +
                             128)] *
            input1_shared1[((((int)threadIdx.z) * 32) + 8)]));
      compute_local1[0] =
          (compute_local1[0] +
           (pad_temp_shared[(((((int)threadIdx.y) * 4) + ((int)threadIdx.x)) +
                             144)] *
            input1_shared1[((((int)threadIdx.z) * 32) + 9)]));
      compute_local1[0] =
          (compute_local1[0] +
           (pad_temp_shared[(((((int)threadIdx.y) * 4) + ((int)threadIdx.x)) +
                             160)] *
            input1_shared1[((((int)threadIdx.z) * 32) + 10)]));
      compute_local1[0] =
          (compute_local1[0] +
           (pad_temp_shared[(((((int)threadIdx.y) * 4) + ((int)threadIdx.x)) +
                             176)] *
            input1_shared1[((((int)threadIdx.z) * 32) + 11)]));
      compute_local1[0] =
          (compute_local1[0] +
           (pad_temp_shared[(((((int)threadIdx.y) * 4) + ((int)threadIdx.x)) +
                             192)] *
            input1_shared1[((((int)threadIdx.z) * 32) + 12)]));
      compute_local1[0] =
          (compute_local1[0] +
           (pad_temp_shared[(((((int)threadIdx.y) * 4) + ((int)threadIdx.x)) +
                             208)] *
            input1_shared1[((((int)threadIdx.z) * 32) + 13)]));
      compute_local1[0] =
          (compute_local1[0] +
           (pad_temp_shared[(((((int)threadIdx.y) * 4) + ((int)threadIdx.x)) +
                             224)] *
            input1_shared1[((((int)threadIdx.z) * 32) + 14)]));
      compute_local1[0] =
          (compute_local1[0] +
           (pad_temp_shared[(((((int)threadIdx.y) * 4) + ((int)threadIdx.x)) +
                             240)] *
            input1_shared1[((((int)threadIdx.z) * 32) + 15)]));
      compute_local1[0] =
          (compute_local1[0] +
           (pad_temp_shared[(((((int)threadIdx.y) * 4) + ((int)threadIdx.x)) +
                             256)] *
            input1_shared1[((((int)threadIdx.z) * 32) + 16)]));
      compute_local1[0] =
          (compute_local1[0] +
           (pad_temp_shared[(((((int)threadIdx.y) * 4) + ((int)threadIdx.x)) +
                             272)] *
            input1_shared1[((((int)threadIdx.z) * 32) + 17)]));
      compute_local1[0] =
          (compute_local1[0] +
           (pad_temp_shared[(((((int)threadIdx.y) * 4) + ((int)threadIdx.x)) +
                             288)] *
            input1_shared1[((((int)threadIdx.z) * 32) + 18)]));
      compute_local1[0] =
          (compute_local1[0] +
           (pad_temp_shared[(((((int)threadIdx.y) * 4) + ((int)threadIdx.x)) +
                             304)] *
            input1_shared1[((((int)threadIdx.z) * 32) + 19)]));
      compute_local1[0] =
          (compute_local1[0] +
           (pad_temp_shared[(((((int)threadIdx.y) * 4) + ((int)threadIdx.x)) +
                             320)] *
            input1_shared1[((((int)threadIdx.z) * 32) + 20)]));
      compute_local1[0] =
          (compute_local1[0] +
           (pad_temp_shared[(((((int)threadIdx.y) * 4) + ((int)threadIdx.x)) +
                             336)] *
            input1_shared1[((((int)threadIdx.z) * 32) + 21)]));
      compute_local1[0] =
          (compute_local1[0] +
           (pad_temp_shared[(((((int)threadIdx.y) * 4) + ((int)threadIdx.x)) +
                             352)] *
            input1_shared1[((((int)threadIdx.z) * 32) + 22)]));
      compute_local1[0] =
          (compute_local1[0] +
           (pad_temp_shared[(((((int)threadIdx.y) * 4) + ((int)threadIdx.x)) +
                             368)] *
            input1_shared1[((((int)threadIdx.z) * 32) + 23)]));
      compute_local1[0] =
          (compute_local1[0] +
           (pad_temp_shared[(((((int)threadIdx.y) * 4) + ((int)threadIdx.x)) +
                             384)] *
            input1_shared1[((((int)threadIdx.z) * 32) + 24)]));
      compute_local1[0] =
          (compute_local1[0] +
           (pad_temp_shared[(((((int)threadIdx.y) * 4) + ((int)threadIdx.x)) +
                             400)] *
            input1_shared1[((((int)threadIdx.z) * 32) + 25)]));
      compute_local1[0] =
          (compute_local1[0] +
           (pad_temp_shared[(((((int)threadIdx.y) * 4) + ((int)threadIdx.x)) +
                             416)] *
            input1_shared1[((((int)threadIdx.z) * 32) + 26)]));
      compute_local1[0] =
          (compute_local1[0] +
           (pad_temp_shared[(((((int)threadIdx.y) * 4) + ((int)threadIdx.x)) +
                             432)] *
            input1_shared1[((((int)threadIdx.z) * 32) + 27)]));
      compute_local1[0] =
          (compute_local1[0] +
           (pad_temp_shared[(((((int)threadIdx.y) * 4) + ((int)threadIdx.x)) +
                             448)] *
            input1_shared1[((((int)threadIdx.z) * 32) + 28)]));
      compute_local1[0] =
          (compute_local1[0] +
           (pad_temp_shared[(((((int)threadIdx.y) * 4) + ((int)threadIdx.x)) +
                             464)] *
            input1_shared1[((((int)threadIdx.z) * 32) + 29)]));
      compute_local1[0] =
          (compute_local1[0] +
           (pad_temp_shared[(((((int)threadIdx.y) * 4) + ((int)threadIdx.x)) +
                             480)] *
            input1_shared1[((((int)threadIdx.z) * 32) + 30)]));
      compute_local1[0] =
          (compute_local1[0] +
           (pad_temp_shared[(((((int)threadIdx.y) * 4) + ((int)threadIdx.x)) +
                             496)] *
            input1_shared1[((((int)threadIdx.z) * 32) + 31)]));
      __syncthreads();
      pad_temp_shared[(((((int)threadIdx.z) * 32) + (((int)threadIdx.y) * 8)) +
                       (((int)threadIdx.x) * 2))] =
          relu(input0[(
      ...
      compute[((((((((int)blockIdx.z) * 1024) + (((int)threadIdx.z) * 64)) +
                ...
                (((int)blockIdx.x) * 4)) +
               ((int)threadIdx.x))] = compute_local[0];
      output1[((((((((int)blockIdx.z) * 1024) + (((int)threadIdx.z) * 64)) +
                  (((int)blockIdx.y) * 32)) +
                 (((int)threadIdx.y) * 8)) +
                (((int)blockIdx.x) * 4)) +
...
BlockFusionKernel_float_float_float_float_float_cuda_Convolution_Convolution_139(
  ...
  // __shared__ char shared_buffer[4096+2048];
  __shared__ char shared_buffer[4096];

  if ((int)blockIdx.x >= 0 && (int)blockIdx.x <= 31) {
    Convolution_float_float_float_cuda_Convolution_1477_block_kernel(
        input0, input1, output0, threadIdx.x, blockIdx.x - 0, shared_buffer);
    // fuse2_Convolution_float_float_float_cuda_Convolution_1477_block_kernel(input0,
    // input1, input2,output0, output1, threadIdx.x, blockIdx.x - 0,
    // shared_buffer);
