...
__device__ void operator_avg_pool_h_128_8_8_3x3_1(const float *input,
                                                  float *output, int blockidx) {
...
extern "C" __global__ void BlockFusionKernel_2_AvgPool_1361(float *input0,
                                                            float *input1,
                                                            float *output0,
                                                            float *output1) {

  if ((int)blockIdx.x >= 0 && (int)blockIdx.x <= 31) {
    operator_avg_pool_h_128_8_8_3x3_1(input0, output0, blockIdx.x);
  } else if ((int)blockIdx.x >= 32 && (int)blockIdx.x <= 63) {
    operator_avg_pool_h_128_8_8_3x3_1(input1, output1, blockIdx.x - 32);
  }
}
...
extern void BlockFusionKernel_2_AvgPool_1361_Call(
  ...
  BlockFusionKernel_2_AvgPool_1361<<<grids, blocks, mem, stream>>>(
