...
void Constant_float_cuda_Constant_2041(cudaStream_t stream, float *output0) {
  std::ifstream bin_file("./Constant/Constant_2041_0.bin",
...
void Constant_float_cuda_Constant_2695(cudaStream_t stream, float *output0) {
  std::ifstream bin_file("./Constant/Constant_2695_0.bin",
                         std::ios::in | std::ios::binary);
  if (bin_file.fail()) {
...
void Constant_float_cuda_Constant_2470(cudaStream_t stream, float *output0) {
  std::ifstream bin_file("./Constant/Constant_2470_0.bin",
                         std::ios::in | std::ios::binary);
  if (bin_file.fail()) {
...
void Constant_float_cuda_Constant_2701(cudaStream_t stream, float *output0) {
  std::ifstream bin_file("./Constant/Constant_2701_0.bin",
                         std::ios::in | std::ios::binary);
  if (bin_file.fail()) {
...
void Constant_float_cuda_Constant_431(cudaStream_t stream, float *output0) {
  std::ifstream bin_file("./Constant/Constant_431_0.bin",
                         std::ios::in | std::ios::binary);
  if (bin_file.fail()) {
...
// Node name:	Constant_2940
// Description:	Constant
// Input:
// Output:
//	- name: Constant_2940_0	type: float	shape: Shape{1, 128, 8, 8}
void Constant_float_cuda_Constant_2940(cudaStream_t stream, float *output0) {
  std::ifstream bin_file("./Constant/Constant_2940_0.bin",
                         std::ios::in | std::ios::binary);
  if (bin_file.fail()) {
    printf("Load Constant_2940_0 failed.\n");
    exit(1);
  }
...
// Node name:	Constant_2889
// Description:	Constant
// Input:
// Output:
//	- name: Constant_2889_0	type: float	shape: Shape{1, 64, 16, 16}
void Constant_float_cuda_Constant_2889(cudaStream_t stream, float *output0) {
  std::ifstream bin_file("./Constant/Constant_2889_0.bin",
                         std::ios::in | std::ios::binary);
  if (bin_file.fail()) {
    printf("Load Constant_2889_0 failed.\n");
    exit(1);
  }
  char *tmp_mem = new char[65536];
  bin_file.read(tmp_mem, 65536);
...
// Node name:	Constant_2891
// Description:	Constant
// Input:
// Output:
//	- name: Constant_2891_0	type: float	shape: Shape{1, 64, 16, 16}
void Constant_float_cuda_Constant_2891(cudaStream_t stream, float *output0) {
  std::ifstream bin_file("./Constant/Constant_2891_0.bin",
                         std::ios::in | std::ios::binary);
  if (bin_file.fail()) {
    printf("Load Constant_2891_0 failed.\n");
    exit(1);
  }
  char *tmp_mem = new char[65536];
  bin_file.read(tmp_mem, 65536);
...
// Node name:	Constant_2974
// Description:	Constant
// Input:
// Output:
//	- name: Constant_2974_0	type: float	shape: Shape{1, 32, 32, 32}
void Constant_float_cuda_Constant_2974(cudaStream_t stream, float *output0) {
  std::ifstream bin_file("./Constant/Constant_2974_0.bin",
                         std::ios::in | std::ios::binary);
  if (bin_file.fail()) {
    printf("Load Constant_2974_0 failed.\n");
    exit(1);
  }
...
void Constant_float_cuda_Constant_3028(cudaStream_t stream, float *output0) {
  std::ifstream bin_file("./Constant/Constant_3028_0.bin",
                         std::ios::in | std::ios::binary);
  if (bin_file.fail()) {
...
void Constant_float_cuda_Constant_2783(cudaStream_t stream, float *output0) {
  std::ifstream bin_file("./Constant/Constant_2783_0.bin",
                         std::ios::in | std::ios::binary);
  if (bin_file.fail()) {
...
void Constant_float_cuda_Constant_451(cudaStream_t stream, float *output0) {
  std::ifstream bin_file("./Constant/Constant_451_0.bin",
                         std::ios::in | std::ios::binary);
  if (bin_file.fail()) {
...
// Fused functions:
// Convolution_float_float_float_cuda_Convolution_1648<<<dim3(1, 4, 16), dim3(8,
// 2, 8), 0, 0>>>(DepthwiseConv2dNative_1640_0, Constant_2677_0,
// Convolution_1648_0);
// Convolution_float_float_float_cuda_Convolution_1644<<<dim3(1, 4, 16), dim3(8,
// 2, 8), 0, 0>>>(DepthwiseConv2dNative_1638_0, Constant_2671_0,
// Convolution_1644_0);
// Convolution_float_float_float_cuda_Convolution_1646<<<dim3(1, 4, 16), dim3(8,
// 2, 8), 0, 0>>>(DepthwiseConv2dNative_1639_0, Constant_2674_0,
// Convolution_1646_0);
// Matched_Pattern_float_float_float_float_cuda_Matched_Pattern_3165<<<dim3(1,
// 4, 16), dim3(8, 2, 8), 0, 0>>>(DepthwiseConv2dNative_1624_0, Constant_2665_0,
// Constant_3166_0, Relu_1641_0);
// Matched_Pattern_float_float_float_float_cuda_Matched_Pattern_3167<<<dim3(1,
// 4, 16), dim3(8, 2, 8), 0, 0>>>(DepthwiseConv2dNative_1625_0, Constant_2668_0,
// Constant_3168_0, Relu_1642_0); Deduped function map: <src_function_name :
// deduped_function_name> Convolution_float_float_float_cuda_Convolution_1644 :
// Convolution_float_float_float_cuda_Convolution_1648
// Convolution_float_float_float_cuda_Convolution_1646 :
// Convolution_float_float_float_cuda_Convolution_1648
// Matched_Pattern_float_float_float_float_cuda_Matched_Pattern_3167 :
// Matched_Pattern_float_float_float_float_cuda_Matched_Pattern_3165
...
Convolution_float_float_float_cuda_Convolution_1648_block_kernel(
...
//	- name: Relu_1641_0	type: float	shape: Shape{1, 128, 8, 8}
__device__ __forceinline__ void
Matched_Pattern_float_float_float_float_cuda_Matched_Pattern_3165_block_kernel(
...
//64, 16, 16}
// Fused functions:
// Add_float_float_float_cuda_Add_2358<<<dim3(32, 1, 1), dim3(512, 1, 1), 0,
// 0>>>(Convolution_1071_0, Constant_2888_0, BatchNormInference_1076_0);
// FusedKernel_float_float_float_float_float_cuda_Add_Add_Add_33<<<dim3(32, 1,
// 1), dim3(512, 1, 1), 0, 0>>>(Convolution_1067_0, Constant_2976_0,
// Convolution_1069_0, Constant_2887_0, Add_1081_0);
// DepthwiseConv2dNative_float_float_float_cuda_DepthwiseConv2dNative_1072<<<dim3(128,
// 1, 1), dim3(128, 1, 1), 0, 0>>>(Relu_1064_0, Constant_27_0,
// DepthwiseConv2dNative_1072_0);
// DepthwiseConv2dNative_float_float_float_cuda_DepthwiseConv2dNative_1073<<<dim3(128,
// 1, 1), dim3(128, 1, 1), 0, 0>>>(Relu_1065_0, Constant_41_0,
// DepthwiseConv2dNative_1073_0); Deduped function map: <src_function_name :
...
//64, 16, 16}
__device__ __forceinline__ void
Add_float_float_float_cuda_Add_2358_block_kernel(float *input0, float *input1,
...
//	- name: Add_1081_0	type: float	shape: Shape{1, 64, 16, 16}
// Fused functions:
// Add_float_float_float_cuda_Add_2352<<<dim3(32, 1, 1), dim3(512, 1, 1), 0,
// 0>>>(Convolution_1067_0, Constant_2976_0, BatchNormInference_1074_0);
// Add_float_float_float_cuda_Add_2355<<<dim3(32, 1, 1), dim3(512, 1, 1), 0,
// 0>>>(Convolution_1069_0, Constant_2887_0, BatchNormInference_1075_0);
// Add_float_float_float_cuda_Add_1081<<<dim3(32, 1, 1), dim3(512, 1, 1), 0,
// 0>>>(BatchNormInference_1074_0, BatchNormInference_1075_0, Add_1081_0);
__device__ __forceinline__ void
FusedKernel_float_float_float_float_float_cuda_Add_Add_Add_33_block_kernel(
...
//64, 16, 16}
__device__ __forceinline__ void
DepthwiseConv2dNative_float_float_float_cuda_DepthwiseConv2dNative_1072_block_kernel(
    float *input0, float *input1, float *output0, int thread_id, int block_id,
    char *shared_buffer) {
  if (thread_id >= 128) {
    return;
...
//64, 16, 16}
__device__ __forceinline__ void
DepthwiseConv2dNative_float_float_float_cuda_DepthwiseConv2dNative_1073_block_kernel(
    float *input0, float *input1, float *output0, int thread_id, int block_id,
    char *shared_buffer) {
  if (thread_id >= 128) {
    return;
...
extern "C" __global__ void
BlockFusionKernel_float_float_float_float_float_float_float_float_float_float_float_float_float_float_cuda_Add_fused_kernel_DepthwiseConv2dNative_DepthwiseConv2dNative_80(
    float *input0, float *input1, float *input2, float *input3, float *input4,
    float *input5, float *input6, float *input7, float *input8, float *input9,
    float *output0, float *output1, float *output2, float *output3) {

  if ((int)blockIdx.x >= 0 && (int)blockIdx.x <= 31) {
    Add_float_float_float_cuda_Add_2358_block_kernel(
        input0, input1, output0, threadIdx.x, blockIdx.x - 0, NULL);
  } else if ((int)blockIdx.x >= 32 && (int)blockIdx.x <= 63) {
    FusedKernel_float_float_float_float_float_cuda_Add_Add_Add_33_block_kernel(
        input3, input2, input5, input4, output1, threadIdx.x, blockIdx.x - 32,
        NULL);
...
void AvgPool_float_float_cuda_lib_AvgPool_911(cudnnHandle_t cudnn_handle,
...
// grid(64,1,1) block(256,1,1)
__device__ void operator_avg_pool_h_64_16_16_3x3_1(const float *input,
                                                   float *output,
                                                   int blockidx) {
...
extern "C" __global__ void BlockFusionKernel_2_AvgPool_911(float *input0,
                                                           float *input1,
                                                           float *output0,
                                                           float *output1) {

  if ((int)blockIdx.x >= 0 && (int)blockIdx.x <= 63) {
    operator_avg_pool_h_64_16_16_3x3_1(input0, output0, blockIdx.x);
  } else if ((int)blockIdx.x >= 64 && (int)blockIdx.x <= 127) {
    operator_avg_pool_h_64_16_16_3x3_1(input1, output1, blockIdx.x - 64);
  }
}
...
extern void BlockFusionKernel_2_AvgPool_911_Call(
  ...
  BlockFusionKernel_2_AvgPool_911<<<grids, blocks, mem, stream>>>(
