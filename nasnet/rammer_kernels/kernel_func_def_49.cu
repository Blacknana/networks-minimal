...
void Constant_float_cuda_Constant_3052(cudaStream_t stream, float *output0) {
  std::ifstream bin_file("./Constant/Constant_3052_0.bin",
...
void Constant_float_cuda_Constant_2056(cudaStream_t stream, float *output0) {
  std::ifstream bin_file("./Constant/Constant_2056_0.bin",
                         std::ios::in | std::ios::binary);
  if (bin_file.fail()) {
...
void Constant_float_cuda_Constant_132(cudaStream_t stream, float *output0) {
  std::ifstream bin_file("./Constant/Constant_132_0.bin",
                         std::ios::in | std::ios::binary);
  if (bin_file.fail()) {
...
void Constant_float_cuda_Constant_2536(cudaStream_t stream, float *output0) {
  std::ifstream bin_file("./Constant/Constant_2536_0.bin",
                         std::ios::in | std::ios::binary);
  if (bin_file.fail()) {
...
void Constant_float_cuda_Constant_164(cudaStream_t stream, float *output0) {
  std::ifstream bin_file("./Constant/Constant_164_0.bin",
                         std::ios::in | std::ios::binary);
  if (bin_file.fail()) {
...
void Constant_float_cuda_Constant_272(cudaStream_t stream, float *output0) {
  std::ifstream bin_file("./Constant/Constant_272_0.bin",
                         std::ios::in | std::ios::binary);
  if (bin_file.fail()) {
...
void Constant_float_cuda_Constant_2086(cudaStream_t stream, float *output0) {
  std::ifstream bin_file("./Constant/Constant_2086_0.bin",
                         std::ios::in | std::ios::binary);
  if (bin_file.fail()) {
...
void Constant_float_cuda_Constant_2951(cudaStream_t stream, float *output0) {
  std::ifstream bin_file("./Constant/Constant_2951_0.bin",
                         std::ios::in | std::ios::binary);
  if (bin_file.fail()) {
...
void Constant_float_cuda_Constant_2359(cudaStream_t stream, float *output0) {
  std::ifstream bin_file("./Constant/Constant_2359_0.bin",
                         std::ios::in | std::ios::binary);
  if (bin_file.fail()) {
...
void Constant_float_cuda_Constant_2278(cudaStream_t stream, float *output0) {
  std::ifstream bin_file("./Constant/Constant_2278_0.bin",
                         std::ios::in | std::ios::binary);
  if (bin_file.fail()) {
...
void Constant_float_cuda_Constant_346(cudaStream_t stream, float *output0) {
  std::ifstream bin_file("./Constant/Constant_346_0.bin",
                         std::ios::in | std::ios::binary);
  if (bin_file.fail()) {
...
extern "C" __launch_bounds__(256) __global__
    void Divide_float_float_float_cuda_Divide_1759(float *input0, float *input1,
                                                   float *output0) {
  output0[blockIdx.x * 256 + threadIdx.x] =
      fdividef(input0[blockIdx.x * 256 + threadIdx.x],
               input1[blockIdx.x * 256 + threadIdx.x]);
}
extern void Divide_float_float_float_cuda_Divide_1759_Call(
  ...
  Divide_float_float_float_cuda_Divide_1759<<<grids, blocks, mem, stream>>>(
      input0, input1, output0);
}
// Node name:	 BlockFusion
// Input:
//	- name: Convolution_1455_0	type: float	shape: Shape{1, 128, 8,
//8}
//	- name: Constant_2763_0	type: float	shape: Shape{1, 128, 8, 8}
//	- name: Constant_2764_0	type: float	shape: Shape{1, 128, 8, 8}
//	- name: Convolution_1457_0	type: float	shape: Shape{1, 128, 8,
//8}
//	- name: Constant_2935_0	type: float	shape: Shape{1, 128, 8, 8}
//	- name: Convolution_1459_0	type: float	shape: Shape{1, 128, 8,
//8}
...
//128, 8, 8}
// Fused functions:
// Add_float_float_float_cuda_Add_2565<<<dim3(16, 1, 1), dim3(512, 1, 1), 0,
// 0>>>(Convolution_1455_0, Constant_2763_0, BatchNormInference_1462_0);
// FusedKernel_float_float_float_float_float_cuda_Add_Add_Add_54<<<dim3(16, 1,
// 1), dim3(512, 1, 1), 0, 0>>>(Convolution_1457_0, Constant_2764_0,
// Convolution_1459_0, Constant_2935_0, Add_1469_0);
// DepthwiseConv2dNative_float_float_float_cuda_DepthwiseConv2dNative_1460<<<dim3(64,
// 1, 1), dim3(128, 1, 1), 0, 0>>>(Relu_1452_0, Constant_151_0,
// DepthwiseConv2dNative_1460_0);
// DepthwiseConv2dNative_float_float_float_cuda_DepthwiseConv2dNative_1461<<<dim3(64,
// 1, 1), dim3(128, 1, 1), 0, 0>>>(Relu_1453_0, Constant_309_0,
// DepthwiseConv2dNative_1461_0); Deduped function map: <src_function_name :
...
Add_float_float_float_cuda_Add_2565_block_kernel(float *input0, float *input1,
...
//	- name: Add_1469_0	type: float	shape: Shape{1, 128, 8, 8}
// Fused functions:
// Add_float_float_float_cuda_Add_2568<<<dim3(16, 1, 1), dim3(512, 1, 1), 0,
// 0>>>(Convolution_1457_0, Constant_2764_0, BatchNormInference_1463_0);
// Add_float_float_float_cuda_Add_2571<<<dim3(16, 1, 1), dim3(512, 1, 1), 0,
// 0>>>(Convolution_1459_0, Constant_2935_0, BatchNormInference_1464_0);
// Add_float_float_float_cuda_Add_1469<<<dim3(16, 1, 1), dim3(512, 1, 1), 0,
// 0>>>(BatchNormInference_1464_0, BatchNormInference_1463_0, Add_1469_0);
__device__ __forceinline__ static void
FusedKernel_float_float_float_float_float_cuda_Add_Add_Add_54_block_kernel(
...
//128, 8, 8}
__device__ __forceinline__ static void
DepthwiseConv2dNative_float_float_float_cuda_DepthwiseConv2dNative_1460_block_kernel(
...
//128, 8, 8}
__device__ __forceinline__ static void
DepthwiseConv2dNative_float_float_float_cuda_DepthwiseConv2dNative_1461_block_kernel(
    float *input0, float *input1, float *output0, int thread_id, int block_id,
    char *shared_buffer) {
  if (thread_id >= 128) {
    return;
...
BlockFusionKernel_float_float_float_float_float_float_float_float_float_float_float_float_float_float_cuda_Add_fused_kernel_DepthwiseConv2dNative_DepthwiseConv2dNative_136(
  ...
  if ((int)blockIdx.x >= 0 && (int)blockIdx.x <= 15) {
    Add_float_float_float_cuda_Add_2565_block_kernel(
        input0, input1, output0, threadIdx.x, blockIdx.x - 0 + 0, NULL);
  } else if ((int)blockIdx.x >= 16 && (int)blockIdx.x <= 31) {
    FusedKernel_float_float_float_float_float_cuda_Add_Add_Add_54_block_kernel(
        input3, input2, input5, input4, output1, threadIdx.x,
        blockIdx.x - 16 + 0, NULL);
  } else if ((int)blockIdx.x >= 32 && (int)blockIdx.x <= 95) {
    DepthwiseConv2dNative_float_float_float_cuda_DepthwiseConv2dNative_1460_block_kernel(
        input6, input7, output2, threadIdx.x, blockIdx.x - 32 + 0, NULL);
  } else if ((int)blockIdx.x >= 96 && (int)blockIdx.x <= 159) {
    DepthwiseConv2dNative_float_float_float_cuda_DepthwiseConv2dNative_1461_block_kernel(
        input8, input9, output3, threadIdx.x, blockIdx.x - 96 + 0, NULL);
  }
}
extern void
...
// Fused functions:
// Convolution_float_float_float_cuda_Convolution_1193<<<dim3(1, 16, 4), dim3(8,
// 1, 16), 0, 0>>>(DepthwiseConv2dNative_1187_0, Constant_2422_0,
// Convolution_1193_0);
// Convolution_float_float_float_cuda_Convolution_1195<<<dim3(1, 16, 4), dim3(8,
// 1, 16), 0, 0>>>(DepthwiseConv2dNative_1188_0, Constant_2425_0,
// Convolution_1195_0);
// Convolution_float_float_float_cuda_Convolution_1197<<<dim3(1, 16, 4), dim3(8,
// 1, 16), 0, 0>>>(DepthwiseConv2dNative_1189_0, Constant_2428_0,
// Convolution_1197_0);
// Matched_Pattern_float_float_float_float_cuda_Matched_Pattern_3093<<<dim3(1,
// 16, 4), dim3(8, 1, 16), 0, 0>>>(DepthwiseConv2dNative_1173_0,
// Constant_2416_0, Constant_3094_0, Relu_1190_0);
// Matched_Pattern_float_float_float_float_cuda_Matched_Pattern_3095<<<dim3(1,
// 16, 4), dim3(8, 1, 16), 0, 0>>>(DepthwiseConv2dNative_1174_0,
// Constant_2419_0, Constant_3096_0, Relu_1191_0); Deduped function map:
// <src_function_name : deduped_function_name>
// Convolution_float_float_float_cuda_Convolution_1195 :
// Convolution_float_float_float_cuda_Convolution_1193
// Convolution_float_float_float_cuda_Convolution_1197 :
// Convolution_float_float_float_cuda_Convolution_1193
// Matched_Pattern_float_float_float_float_cuda_Matched_Pattern_3095 :
// Matched_Pattern_float_float_float_float_cuda_Matched_Pattern_3093
...
//16}
__device__ __forceinline__ static void
Convolution_float_float_float_cuda_Convolution_1193_block_kernel(
    float *input0, float *input1, float *output0, int thread_id, int block_id,
    char *shared_buffer) {
  if (thread_id >= 128) {
    return;
...
//	- name: Relu_1190_0	type: float	shape: Shape{1, 64, 16, 16}
__device__ __forceinline__ static void
Matched_Pattern_float_float_float_float_cuda_Matched_Pattern_3093_block_kernel(
...
// Fused functions:
// FusedKernel_float_float_float_float_cuda_Add_Add_21<<<dim3(64, 1, 1),
// dim3(512, 1, 1), 0, 0>>>(Convolution_813_0, Constant_2845_0, Slice_769_0,
// Add_822_0); FusedKernel_float_float_float_float_cuda_Add_Add_22<<<dim3(64, 1,
// 1), dim3(512, 1, 1), 0, 0>>>(Convolution_815_0, Constant_2846_0,
// BatchNormInference_749_0, Add_823_0); Deduped function map:
// <src_function_name : deduped_function_name>
// FusedKernel_float_float_float_float_cuda_Add_Add_22 :
// FusedKernel_float_float_float_float_cuda_Add_Add_21
...
//	- name: Add_822_0	type: float	shape: Shape{1, 32, 32, 32}
// Fused functions:
// Add_float_float_float_cuda_Add_2220<<<dim3(64, 1, 1), dim3(512, 1, 1), 0,
// 0>>>(Convolution_813_0, Constant_2845_0, BatchNormInference_819_0);
// Add_float_float_float_cuda_Add_822<<<dim3(64, 1, 1), dim3(512, 1, 1), 0,
// 0>>>(BatchNormInference_819_0, Slice_769_0, Add_822_0);
__device__ __forceinline__ static void
FusedKernel_float_float_float_float_cuda_Add_Add_21_block_kernel(
    float *input0, float *input1, float *input2, float *output0, int thread_id,
    int block_id, char *shared_buffer) {
  if (thread_id >= 512) {
    return;
...
extern "C" __global__ void
BlockFusionKernel_float_float_float_float_float_float_float_float_cuda_fused_kernel_fused_kernel_44(
    float *input0, float *input1, float *input2, float *input3, float *input4,
